...
public class CalServiceProxy implements com.example.service.CalService {
  private String _endpoint = null;
  private com.example.service.CalService calService = null;
  ...
  private void _initCalServiceProxy() {
    try {
      calService = (new com.example.service.CalServiceServiceLocator()).getCalService();
      if (calService != null) {
        if (_endpoint != null)
  ...
  public com.example.service.CalService getCalService() {
    if (calService == null)
      _initCalServiceProxy();
    return calService;
  }
