...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.example.service.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:7001/CalculatorServicee/services/CalService";
    ...
    public com.example.service.CalService getCalService() throws javax.xml.rpc.ServiceException {
    ...
    public com.example.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.example.service.CalServiceSoapBindingStub _stub = new com.example.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.example.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.example.service.CalServiceSoapBindingStub _stub = new com.example.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.example.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.example.com", "CalService"));
        }
